...
Function Main
    ...
    Wait3 IE
    'IE.Navigate "https://th.jobsdb.com/TH/EN/Search/FindJobs?KeyOpt=COMPLEX&JSRV=1&RLRSF=1&JobCat=131&Career=4,3&JSSRC=CSBAS&posFix=1&keepExtended=1"
    IE.Navigate "https://th.jobsdb.com/TH/EN/Search/FindJobs?KeyOpt=COMPLEX&JSRV=1&RLRSF=1&JobCat=131&Career=4&JSSRC=JSRAS&keepExtended=1&recentSelected=94"
	Wait3s IE
      ...
      if(IsNumeric(getapplyurl(0))) then
        ...
        for each applybtn in applybtns
          if(applybtn.innerhtml = "Apply now") then
            ...
            WaitIE2 IE2
            IE2.document.getElementByID("c_PeAySyItDap_JbSrIo0").value = "Sir, I just started my career. While doing Masters study I work as a part-timer as a software developer and I worked as an individual developer and learned new tech simultaneously for the development. Presently I am looking for an opportunity to in Software development."
            WaitIE2 IE2
            applybtn.click
            WaitIE22 IE2
          end if
