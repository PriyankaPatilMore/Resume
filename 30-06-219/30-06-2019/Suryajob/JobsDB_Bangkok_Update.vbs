      ...
      if(IsNumeric(getapplyurl(0))) then
        ...
        for each applybtn in applybtns
          if(applybtn.innerhtml = "Apply now") then
            ...
            WaitIE2 IE2
            IE2.document.getElementByID("c_PeAySyItDap_JbSrIo0").value = "Sir, I just started my career. While doing UG and Masters I work as a part-timer(1* year) in software field and I worked as an individual developer and learned new tech simultaneously to develop Web/Mobile app and API's. Presently I am looking for an opportunity to in Software development."
            WaitIE2 IE2
            applybtn.click
            WaitIE22 IE2
          end if
